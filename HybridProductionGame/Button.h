...
public:
	Button(const char* s, SDL_Rect src, SDL_Rect dst, const char* text, int w, int h);
	~Button();
	void Update();
	void Render();
};
...
private: 
	void Execute();
public:
	ExitButton(const char* s, SDL_Rect src, SDL_Rect dst, const char * text, int w, int h);
};
...
private:
	void Execute();
public:
	ResumeButton(const char* s, SDL_Rect src, SDL_Rect dst, const char * text, int w, int h);
};
...
private:
	void Execute();
public:
	MainMenuButton(const char* s, SDL_Rect src, SDL_Rect dst, const char * text, int w, int h);
};